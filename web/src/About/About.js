                ...
                {info && <Table celled>
                    ...
                    <Table.Body>
                        <Table.Row>
                            ...
                            <Table.Cell><a href="https://github.com/aptdeco/hypokorisma" target="_blank" rel="noopener noreferrer">github.com/aptdeco/hypokorisma</a></Table.Cell>
                        </Table.Row>
                        <Table.Row>
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell><a href={"https://github.com/aptdeco/hypokorisma/commit/" + info.commit} target="_blank" rel="noopener noreferrer">{info.commit}</a></Table.Cell>
                        </Table.Row>
                        <Table.Row>
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell><a href="https://github.com/aptdeco/hypokorisma/blob/master/LICENSE.md" target="_blank" rel="noopener noreferrer">MIT</a></Table.Cell>
                        </Table.Row>
                    </Table.Body>
                </Table>}
            </Container>
